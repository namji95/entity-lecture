...
import com.sparta.jpaadvance.orphanRemoval.repository.FoodRepository;
import com.sparta.jpaadvance.orphanRemoval.repository.UserRepository;
...
public class OrphanTest {
  ...
  // entity에 orphanRemoval 옵션을 사용하지 않으면 정상 동작하지 않습니다.
  @Test
  @Transactional
  @Rollback(value = false)
  @DisplayName("연관관계 제거")
